      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar" style="height: auto;">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="{{url('/admin/edit/en')}}">
                <i class="fa fa-th"></i> <span>الصفحة الرئيسية</span> <small class="label pull-right bg-green">Hot</small>
              </a>
            </li>

            <li>
              <a href="{{url('/admin/edit/about/en')}}">
                <i class="fa fa-th"></i> <span>من نحن</span> <small class="label pull-right bg-green">Hot</small>
              </a>
            </li>
            <li>
              <a href="{{url('admin/show/doctors')}}">
                <i class="fa fa-th"></i> <span>أطباء</span> <small class="label pull-right bg-green">Hot</small>
              </a>
            </li>

            <li>
              <a href="{{url('admin/show/specialty')}}">
                <i class="fa fa-th"></i> <span>التخصصات</span> <small class="label pull-right bg-green">Hot</small>
              </a>
            </li>

            <li>
              <a href="{{url('admin/show/news')}}">
                <i class="fa fa-th"></i> <span>الاخبار</span> <small class="label pull-right bg-green">Hot</small>
              </a>
            </li>

            <li>
              <a href="{{url('admin/show/feedbacks')}}">
                <i class="fa fa-th"></i> <span>التعليقات</span> <small class="label pull-right bg-green">Hot</small>
              </a>
            </li>

            <li>
              <a href="{{url('admin/edit/contact/en')}}">
                <i class="fa fa-th"></i> <span>اتصل بنا</span> <small class="label pull-right bg-green">Hot</small>
              </a>
            </li>

            <li>
              <a href="{{url('admin/show/messages')}}">
                <i class="fa fa-th"></i> <span>الرسايل</span> <small class="label pull-right bg-green">Hot</small>
              </a>
            </li>
